...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $msg = AddAssistant($_POST["name"], $_POST["email"], $_POST["password"], $_FILES["profilePicture"], $_POST["docid"], $_POST["education"], $_POST["phone"], $_POST["gender"]);
}
...
<body>
    ...
    <div class="dashboard">
        <div class="title">Add Assistant</div>
        <form action method="post" class="add-box" enctype="multipart/form-data">
            ...
            <p class="level">Doctor</p>
            <select name="docid">
                <?php
                $specializations = getAllDoctors();
